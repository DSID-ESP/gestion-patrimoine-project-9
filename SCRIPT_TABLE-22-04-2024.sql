...
ALTER TABLE ONLY "DLF_PATRIMOINE"."G2010R"."bon_sortie" ADD CONSTRAINT "fka1yvddyp3obk77a1fqouvbxdy" FOREIGN KEY (identifiant_bon_pour) REFERENCES bon_pour(identifiant_bon_pour) NOT DEFERRABLE;
